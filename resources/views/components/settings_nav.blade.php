<div x-data="{ mobileMenuOpen: false, userMenuOpen: false }"
    ...
    <div x-show="mobileMenuOpen" x-transition:enter="transition ease-in-out duration-200 transform"
        ...
        <div class="px-4 py-3 border-b border-slate-200/50">
            <a href="{{ url('/dashboard') }}"
                class="flex items-center gap-2 text-sm text-slate-600 hover:text-blue-600 transition-colors duration-200">
        ...
        <div class="flex-1 overflow-auto py-6">
            ...
            <nav class="grid gap-1 px-4">
                ...
                <a href="{{ url('/settings') }}"
                    class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 {{ navActive('settings') }}">
    ...
    <div
        ...
        <div class="flex-1 overflow-auto py-6">
            ...
            <nav class="grid gap-1 px-4">
                ...
                <!-- Account Settings Link -->
                <a href="{{ url('/settings') }}"
                    class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 {{ dnavActive('settings') }}">
                    <i class="bx bx-cog text-lg"></i>
                    <span class="font-medium">Account Settings</span>
                </a>
