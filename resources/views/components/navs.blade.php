     ...
     <div class="flex-1 overflow-auto py-2">
         <nav class="grid gap-1 px-2">
             ...
             <a href="{{ url('/dashboard') }}"
                 class="flex items-center gap-3 rounded-md px-3 py-2 {{ navActive('dashboard') }}">
                 <!-- Home Icon -->
             ...
             <a href="{{ url('/volunteers') }}"
                 class="flex items-center gap-3 rounded-md px-3 py-2 {{ navActive('volunteers') }}">
                 <!-- Users Icon -->
                 <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
             ...
             <a href="{{ url('/ministries') }}"
                 class="flex items-center gap-3 rounded-md px-3 py-2 {{ navActive('ministries') }}">
                 <!-- Ministry (Church) Icon -->
                 <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
             ...
             <a href="{{ url('/schedule') }}"
                 class="flex items-center gap-3 rounded-md px-3 py-2 {{ navActive('schedule') }}">
                 <!-- Calendar Icon -->
                 <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
             ...
             <a href="{{ url('/attendance') }}"
                 class="flex items-center gap-3 rounded-md px-3 py-2 {{ navActive('attendance') }}">
                 <!-- Attendance (Clipboard + Check) Icon -->
                 <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                         d="M9 12l2 2l4-4m0-5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2m-7-3h4a2 2 0 110 4H9a2 2 0 110-4z" />
                 </svg>
                 <span>Attendance</span>
             </a>

             <a href="{{ url('/tasks') }}"
                 class="flex items-center gap-3 rounded-md px-3 py-2 {{ navActive('tasks') }}">
                 <!-- List Icon -->
                 <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
     ...
     <header class="sticky top-0 z-40 flex h-14 items-center gap-4 border-b bg-white px-4 sm:px-6"
         ...
         <div class="flex flex-1 items-center justify-end">
             <div class="relative flex items-center gap-4">
                 {{-- Notification Bell --}}
                 {{-- <button
                     class="p-2 border rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400">
                 ...
                 {{-- Avatar + Name + Chevron --}}
                 <button type="button"
                     class="inline-flex items-center gap-2 px-2 py-1 rounded-md text-sm font-medium text-gray-700 
