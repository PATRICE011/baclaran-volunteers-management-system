    ...
    <div x-show="mobileMenuOpen"
        ...
        <div class="flex-1 overflow-auto py-6">
            ...
            <nav class="grid gap-1 px-4">
                <!-- Dashboard Link -->
                <a href="{{ url('/dashboard') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 text-slate-600 hover:bg-white/60 hover:text-slate-800 hover:shadow-sm {{ navActive('dashboard') }}">
                    <i class="bx bx-home text-lg"></i>
                    <span class="font-medium">Dashboard</span>
                </a>

                <!-- Volunteers Link -->
                <a href="{{ url('/volunteers') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 text-slate-600 hover:bg-white/60 hover:text-slate-800 hover:shadow-sm {{ navActive('volunteers') }}">
                    <i class="bx bx-group text-lg"></i>
                    <span class="font-medium">Volunteers</span>
                </a>

                <!-- Ministries Link -->
                <a href="{{ url('/ministries') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 text-slate-600 hover:bg-white/60 hover:text-slate-800 hover:shadow-sm {{ navActive('ministries') }}">
                    <i class="bx bx-church text-lg"></i>
                    <span class="font-medium">Ministries</span>
                </a>

                <!-- Events Link -->
                <a href="{{ url('/events') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 text-slate-600 hover:bg-white/60 hover:text-slate-800 hover:shadow-sm {{ navActive('events') }}">
                    <i class="bx bx-calendar text-lg"></i>
                    <span class="font-medium">Events</span>
                </a>

                <!-- Tasks Link -->
                <a href="{{ url('/tasks') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 text-slate-600 hover:bg-white/60 hover:text-slate-800 hover:shadow-sm {{ navActive('tasks') }}">
    ...
    <div class="hidden md:flex w-64 flex-col fixed inset-y-0 z-30 bg-white/95 from-slate-50 to-blue-50/30 border-r border-slate-200/50 backdrop-blur-xl">
        ...
        <div class="flex-1 overflow-auto py-6">
            <nav class="grid gap-1 px-4">
                ...
                @endphp
                <!-- Dashboard Link -->
                <a href="{{ url('/dashboard') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 {{ dnavActive('dashboard') }}">
                    <i class="bx bx-home text-lg"></i>
                    <span class="font-medium">Dashboard</span>
                </a>

                <!-- Volunteers Link -->
                <a href="{{ url('/volunteers') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 {{ dnavActive('volunteers') }}">
                    <i class="bx bx-group text-lg"></i>
                    <span class="font-medium">Volunteers</span>
                </a>

                <!-- Ministries Link -->
                <a href="{{ url('/ministries') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 {{ dnavActive('ministries') }}">
                    <i class="bx bx-church text-lg"></i>
                    <span class="font-medium">Ministries</span>
                </a>

                <!-- event Link -->
                <a href="{{ url('/events') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 {{ dnavActive('events') }}">
                    <i class="bx bx-calendar text-lg"></i>
                    <span class="font-medium">Events</span>
                </a>
                <!-- Tasks Link -->
                <a href="{{ url('/tasks') }}" class="group flex items-center gap-3 rounded-xl px-4 py-3 transition-all duration-200 {{ dnavActive('tasks') }}">
                    <i class="bx bx-list-check text-lg"></i>
                    <span class="font-medium">Tasks</span>
                </a>
            </nav>
