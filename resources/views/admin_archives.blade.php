        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                ...
                <div class="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3">
                    <div class="relative">
                        <input type="text" x-model="searchQuery" placeholder="Search archives..."
                            ...
                            <template x-for="item in getFilteredItems('ministries')" :key="item.id">
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="border border-gray-200 p-3">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="h-8 w-8 bg-green-500 rounded-full flex items-center justify-center text-white text-sm font-medium">
                                                <span x-text="item.name.charAt(0).toUpperCase()"></span>
                                            </div>
                                            <div>
                                                <p class="font-medium text-gray-900" x-text="item.name"></p>
                    ...
                    <table class="w-full border-collapse table-hover">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="border border-gray-200 p-3 text-left text-sm font-semibold text-gray-900">Due
                                    Date</th>
                                <th class="border border-gray-200 p-3 text-left text-sm font-semibold text-gray-900">
                                    Archived Date</th>
                                <th class="border border-gray-200 p-3 text-left text-sm font-semibold text-gray-900">Reason
                        ...
                        <tbody>
                            <template x-for="item in getFilteredItems('tasks')" :key="item.id">
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="border border-gray-200 p-3 text-sm text-gray-700"
                                        x-text="formatDate(item.due_date)"></td>
                                    <td class="border border-gray-200 p-3 text-sm text-gray-700"
                                        x-text="formatDate(item.archived_date)"></td>
                                    <td class="border border-gray-200 p-3">
                                        <span class="badge badge-warning" x-text="item.reason"></span>
            ...
            <div x-show="tab === 'events'" x-cloak>
                <div class="overflow-x-auto">
                    <table class="w-full border-collapse table-hover">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="border border-gray-200 p-3 text-left text-sm font-semibold text-gray-900">Event
                                    Title</th>
                                <th class="border border-gray-200 p-3 text-left text-sm font-semibold text-gray-900">Date
                                </th>
                                <th class="border border-gray-200 p-3 text-left text-sm font-semibold text-gray-900">
                                    Archived Date</th>
                                <th class="border border-gray-200 p-3 text-left text-sm font-semibold text-gray-900">Reason
                        ...
                        <tbody>
                            <template x-for="item in getFilteredItems('events')" :key="item.id">
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="border border-gray-200 p-3">
                                        <input type="checkbox" :value="item.id" x-model="selectedItems"
                                            class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                            ...
                            <tr x-show="getFilteredItems('events').length === 0">
                                <td colspan="7" class="border border-gray-200 p-8">
                                    <div class="empty-state">
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
