    ...
    <div class="flex h-screen">
        ...
        <aside class="hidden md:flex flex-col w-64 bg-white border-r">
            <div class="px-4 py-4 border-b">
                <h1 class="text-lg font-semibold">Church Volunteers</h1>
            </div>
            <nav class="flex-1 px-2 py-4 space-y-1">
                <a href="#" class="flex items-center px-3 py-2 rounded-md bg-gray-100 text-gray-900">
                    <!-- Dashboard Icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M3 7l1.664 1.664A2 2 0 006 9.999h1.34a2 2 0 011.414.586l1.585 1.585A2 2 0 0011.34 13H13a2 2 0 011.414.586l1.585 1.585A2 2 0 0017.34 16H19a2 2 0 001.414-.586L22 13" />
                    </svg>
                    Dashboard
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M17 20h5v-2a4 4 0 00-3-3.87M9 20h5v-2a4 4 0 00-3-3.87M9 
                     20V10a4 4 0 00-8 0v10m12-10a4 4 0 018 0v10" />
                    </svg>
                    Volunteers
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M8 7V3m8 4V3m-4 4h.01M3 11h18M5 20h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v11a2 2 0 002 2z" />
                    </svg>
                    Schedule
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-100">
