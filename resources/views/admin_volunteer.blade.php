            ...
            <div class="bg-white rounded-lg w-full max-w-lg p-6 relative max-h-[80vh] overflow-y-auto">
                ...
                <div id="regTabContent">
                    ...
                    <div class="flex flex-col md:flex-row gap-4 mb-6">
                        ...
                        <div class="flex gap-2">
                            <button id="gridViewBtn"
                                class="px-4 py-2 border rounded text-gray-700 hover:bg-gray-100 bg-white"
                                data-view="grid">
                                <svg class="inline mr-1 h-4 w-4" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                                </svg>
                    ...
                    <div id="gridView" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4"
                        style="display: {{ request('view') === 'list' ? 'none' : 'grid' }};">
                        {{-- This will be dynamically replaced by AJAX --}}
                    </div>
                    <!-- List View -->
                    <div id="listView" class="hidden">
                    ...
                    <div id="registrationModal" class="fixed inset-0 hidden items-center justify-center modal-bg">
                        <div class="bg-white rounded-lg w-full max-w-lg p-6 relative max-h-[80vh] overflow-y-auto">
                            ...
                            <!-- Tabs -->
                            <div id="registrationTabs" class="mb-4 flex gap-2">
                                <button class="reg-tab px-4 py-2 border-b-2 border-blue-600" data-tab="personal"
                                    data-step="1">Basic
                                    Info</button>
                                <button class="reg-tab px-4 py-2 border-b-2 border-transparent tab-locked"
                            ...
                            <div id="regTabContent">
                                ...
                                <div class="reg-content" id="tab-personal">
                                    ...
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium mb-1" for="reg-phone">Mobile
                                            Number</label>
                                        <input id="reg-phone" name="phone" type="tel"
                                            placeholder="+63 912 345 6789" class="w-full border rounded px-3 py-2">
                                    </div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium mb-1" for="reg-email">Email
                                            Address</label>
                                        <input id="reg-email" name="email" type="email"
                                            placeholder="you@example.com" class="w-full border rounded px-3 py-2">
                                    </div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium mb-1"
                                            for="reg-occupation">Occupation</label>
                                        <input id="reg-occupation" name="occupation" type="text"
                                            placeholder="e.g. Software Developer" class="w-full border rounded px-3 py-2">
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            ...
                                            <label class="flex items-center">
                                                <input type="radio" name="civil_status" value="widower"
                                                    class="form-radio mr-2">
                                                Widow(er)
                                            </label>
                                            <label class="flex items-center">
                                            ...
                                            <label class="flex items-center">
                                                <input type="radio" name="civil_status" value="others"
                                                    class="form-radio mr-2" id="civilOthers"> Others
                                            </label>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="grid grid-cols-3 gap-2">
                                            <label class="flex items-center"><input type="checkbox" name="sacraments[]"
                                                    value="baptism" class="form-checkbox mr-2"> Baptism</label>
                                            <label class="flex items-center"><input type="checkbox" name="sacraments[]"
                                                    value="first_communion" class="form-checkbox mr-2"> First
                                                Communion</label>
                                            <label class="flex items-center"><input type="checkbox" name="sacraments[]"
                                                    value="confirmation" class="form-checkbox mr-2"> Confirmation</label>
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="grid grid-cols-1 gap-2">
                                            <label class="flex items-center"><input type="checkbox" name="formations[]"
                                                    value="BOS" class="form-checkbox mr-2"> Basic Orientation Seminar
                                                (BOS)</label>
                                            <label class="flex items-center"><input type="checkbox" name="formations[]"
                                                    value="BFF" class="form-checkbox mr-2"> Basic Faith Formation
                                                (BFF)</label>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="block text-sm font-medium mb-1" for="reg-others">Others</label>
                                        <input id="reg-others" name="others" type="text"
                                            placeholder="Anything else?" class="w-full border rounded px-3 py-2">
                                    </div>
                                </div>
  ...
  `;
    ...
    `;
                    ...
                    document.getElementById('submitRegistration').addEventListener('click', () => {
                        ...
                        document.querySelectorAll('input[name="sacraments[]"]:checked').forEach(cb => formData.append(
                            'sacraments[]', cb.value));
                        document.querySelectorAll('input[name="formations[]"]:checked').forEach(cb => formData.append(
                            'formations[]', cb.value));
                    ...
                    function resetVolunteerForm() {
                        ...
                        // Checkboxes & radios
                        document.querySelectorAll('#registrationModal input[type="checkbox"], #registrationModal input[type="radio"]')
                    ...
                    document.querySelectorAll('.year-select').forEach(select => {
                        select.addEventListener('change', function() {
                            ...
                            const startYear = parseInt(document.querySelector(
                                `select[name="timeline_start_year[]"][data-row="${row}"]`).value);
                            const endYear = parseInt(document.querySelector(
                                `select[name="timeline_end_year[]"][data-row="${row}"]`).value);
                    ...
                    document.querySelectorAll('.reg-tab').forEach(tab => {
                        tab.addEventListener('click', function() {
                            ...
                            document.querySelectorAll('.reg-tab').forEach(t => t.classList.replace('border-blue-600',
                                'border-transparent'));
  ...
  `;
                        ...
                        fetch(`/volunteers/${id}`, {
                            ...
                            .then(volunteer => {
                                ...
                                // Format join date
                                const joinDate = volunteer.created_at ? new Date(volunteer.created_at).toLocaleDateString() :
                                    'Unknown';
                                ...
                                const statusClass = volunteer.has_complete_profile ? 'bg-green-100 text-green-700' :
