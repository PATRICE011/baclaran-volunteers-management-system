  ...
  <div class="bg-white rounded-lg w-full max-w-lg p-6 relative">
    ...
    <div id="regTabContent">
      <div class="reg-content" id="tab-personal">
        ...
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1" for="reg-name">Nickname</label>
          <input id="reg-name" type="text" placeholder="John Smith" class="w-full border rounded px-3 py-2">
        </div>

        <div class="mb-4">
          <label class="block text-sm font-medium mb-1" for="reg-dob">Date of Birth</label>
          <input id="reg-dob" type="date" placeholder="dd/mm/yyyy" class="w-full border rounded px-3 py-2">
        </div>
        ...
        <div class="mb-4">
          ...
          <input id="reg-phone" type="tel" placeholder="+63 912 345 6789" class="w-full border rounded px-3 py-2">
        </div>
        ...
        <div class="mb-4">
          ...
          <input id="reg-occupation" type="text" placeholder="e.g., Software Developer" class="w-full border rounded px-3 py-2">
        </div>
      </div>
