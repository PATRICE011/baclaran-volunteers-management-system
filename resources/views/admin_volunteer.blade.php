...
@section('content')
    ...
    <div class="min-h-screen pt-16 md:pl-64 bg-gradient-to-b from-white to-slate-50">
        ...
        <div id="registrationModal" class="fixed inset-0 hidden items-center justify-center modal-bg z-50">
            <div
                class="bg-white rounded-xl w-full max-w-2xl p-8 relative max-h-[90vh] overflow-y-auto shadow-lg min-h-[500px]">
                <!-- Close Button -->
                ...
                <div id="registrationTabs" class="mb-6 flex gap-3 border-b pb-2">
                    ...
                    <button
                        class="reg-tab text-sm font-medium px-4 py-2 border-b-2 border-transparent text-gray-500 tab-locked"
                ...
                <div id="regTabContent">
                    ...
                    <div class="reg-content hidden space-y-6" id="tab-sheet">
                        ...
                        <div>
                            ...
                            <div class="space-y-3 mt-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <select name="bos_year" class="formation-year border rounded px-2 py-1 text-sm"
                                        disabled>
                                ...
                                <div class="flex items-center gap-2">
                                    <input type="checkbox" name="formations[]" value="Diocesan Basic Formation"
                                        class="formation-checkbox">
                                    <span class="text-sm w-48">Diocesan Basic Formation</span>
                                    <select name="diocesan_year" class="formation-year border rounded px-2 py-1 text-sm"
                                        disabled>
                                        <option value="">Select Year</option>
                                        @for ($y = date('Y'); $y >= 1980; $y--)
                                            <option value="{{ $y }}">{{ $y }}</option>
                                ...
                                <!-- Safeguarding Policy -->
                                <div class="flex items-center gap-2">
                                    <input type="checkbox" name="formations[]" value="Safeguarding Policy"
                                        class="formation-checkbox">
                                    <span class="text-sm w-48">Safeguarding Policy</span>
                                    <select name="safeguarding_year" class="formation-year border rounded px-2 py-1 text-sm"
                                        disabled>
                                        <option value="">Select Year</option>
                                        @for ($y = date('Y'); $y >= 1980; $y--)
                                            <option value="{{ $y }}">{{ $y }}</option>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mb-2">Please indicate any Organization/Ministry outside the
                                Shrine</p>
                            <div id="affiliations-container" class="space-y-3">
                                <div class="affiliation-entry grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
                                    ...
                                    <div class="flex gap-2 col-span-1">
                                        ...
                                        <span class="flex items-center text-sm">–</span>
                                        <select name="affil_end_year[]" class="border rounded px-2 py-2 w-full year-select">
                                            <option value="">End Year</option>
                                            <option value="present">Present</option>
                                            @for ($y = date('Y'); $y >= 1980; $y--)
                                                <option value="{{ $y }}">{{ $y }}</option>
                            ...
                            <button type="button" id="add-affiliation"
                                class="mt-2 px-3 py-1 text-sm bg-gray-100 rounded hover:bg-gray-200">
    ...
    <div id="profileModal" class="fixed inset-0 hidden items-center justify-center bg-black bg-opacity-40 z-50">
        <!-- Modal Box -->
        <div class="w-full mx-4 sm:mx-auto p-6 relative max-h-[90vh] overflow-y-auto rounded-lg bg-white shadow-lg"
    ...
    <div id="archive-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50">
        <div class="modal-container bg-white rounded-lg shadow-xl p-6 m-4 max-w-md w-full">
            ...
            <div class="flex space-x-3 justify-end">
                <button id="cancel-archive"
                    class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300">
                    Cancel
                </button>
                <button id="confirm-archive"
