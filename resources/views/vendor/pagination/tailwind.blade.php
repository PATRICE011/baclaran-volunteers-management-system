@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex flex-col w-full items-center justify-center space-y-3
+             sm:flex-row sm:space-y-0">
        ...
        <div class="hidden sm:flex sm:items-center sm:justify-center sm:gap-6">
            <div>
