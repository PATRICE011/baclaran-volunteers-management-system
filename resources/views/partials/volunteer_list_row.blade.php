          ...
          <td class="px-6 py-4 whitespace-nowrap cursor-pointer" onclick="openProfile('{{ $volunteer->id }}')">
            <div class="flex items-center">
              ...
              <img src="{{ asset('storage/' . $volunteer->profile_picture) }}"
                alt="{{ $displayName }}" class="w-10 h-10 rounded-full mr-3 object-cover">
              @else
              ...
              <div>
                ...
                @if($volunteer->active_for)
                <div class="text-sm text-gray-500">active for {{ $volunteer->active_for }}</div>
                @endif
