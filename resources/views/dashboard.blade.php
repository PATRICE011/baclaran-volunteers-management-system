...
@section('content')
  ...
  @php
    ...
    $metrics = [
        ...
        'activeMinistries' => 8,
        'recentVolunteers' => [
            ['id' => 1, 'name' => 'Sarah Johnson', 'role' => 'Worship Team', 'avatar' => 'SJ', 'status' => 'active', 'joined' => '2023-01-15'],
            ['id' => 2, 'name' => 'Michael Chen', 'role' => "Children's Ministry", 'avatar' => 'MC', 'status' => 'active', 'joined' => '2023-02-10'],
            ['id' => 3, 'name' => 'David Wilson', 'role' => 'Tech Team', 'avatar' => 'DW', 'status' => 'active', 'joined' => '2023-03-05'],
            ['id' => 4, 'name' => 'Rebecca Taylor', 'role' => 'Hospitality', 'avatar' => 'RT', 'status' => 'pending', 'joined' => '2023-06-01'],
        ],
        'upcomingTasks' => [
            [
                'id' => 1,
        ...
        'ministryData' => [
            ['name' => 'Worship', 'volunteers' => 25, 'color' => 'bg-blue-500'],
            ['name' => "Children's", 'volunteers' => 18, 'color' => 'bg-green-500'],
            ['name' => 'Tech', 'volunteers' => 12, 'color' => 'bg-purple-500'],
            ['name' => 'Hospitality', 'volunteers' => 15, 'color' => 'bg-yellow-500'],
        ]
    ];
    @endphp
