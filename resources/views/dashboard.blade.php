            ...
            <div class="grid gap-6">
                ...
                <div class="mt-2">
                    ...
                    <div class="inline-flex items-center bg-gray-100 rounded-md p-1">
                        <!-- Active tab button -->
                        <button class="bg-white rounded-md text-gray-700 font-medium px-4 py-2 shadow focus:outline-none"
                            data-target="overview">
                            Overview
                        </button>
                        <!-- Inactive tab buttons -->
                        <button
                            class="rounded-md text-gray-600 px-4 py-2 hover:bg-white hover:text-gray-800 focus:outline-none"
