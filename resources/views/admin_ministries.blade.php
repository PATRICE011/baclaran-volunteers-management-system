                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 mt-1 line-clamp-1">
                                    <span class="inline-flex items-center">
                                        <svg class="w-2.5 h-2.5 mr-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 111.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                                        </svg>
                                        <span class="truncate">Sub-ministry of {{ $ministry->parent->ministry_name }}</span>
                                    </span>
                                </p>
                                @endif
                            </div>
                            <div class="flex-shrink-0 ml-2">
                                <span class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium bg-blue-100 text-blue-800 whitespace-nowrap">
                                    {{
